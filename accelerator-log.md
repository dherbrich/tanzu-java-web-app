...
```json
{
  ...
  "repositoryPrefix" : "tapacr.azurecr.io/denny-herbrich-gke-01/apps-11-05-2022-12-40-32-694002876"
}
```
## Log
```
...
┃ ┃ ┃ ┗ ┗ ┗  Info Will replace [your-registry.io/project->tapacr.azurecr.io/de...(truncated)]
